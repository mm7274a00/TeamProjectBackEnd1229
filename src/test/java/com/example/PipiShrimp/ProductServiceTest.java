...
public class ProductServiceTest {
	...
	public void createTest() {
	    ...
	    Product product1 = new Product(22200, "嚙踝蕭謖�嚙踝蕭", "嚙踐��漲敹踝蕭嚙踝�蕭謖�嚙踝蕭", null, 100, 25, 0, true, "", 1, currentDate, null);
	    ...
	    Product product2 = new Product(22, "嚙踝蕭�嚙踝蕭", "嚙踐���蕭�謓蛛蕭嚙踝蕭", null, 299, 25, 12, true, "", 1, currentDate, null);
	    ...
	    Product product3 = new Product(3, "�����", "嚙踐����蕭謑蕭�", null, 3999, 10, 999, false, "", 1, currentDate, null);
